  ...
  return (
    <div ref={formRef} className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="text-center mb-8 border-b border-gray-200 pb-5">
        ...
        <h2 className="text-lg font-semibold mb-4">FASCIA NAME FORM</h2>
        <p className="text-gray-600 mb-2">DEADLINE: 2nd July 2025</p>
        <h3 className="text-md font-semibold mb-2">Aesthetic Medicine & Surgery Conference & Exhibition 2025</h3>
