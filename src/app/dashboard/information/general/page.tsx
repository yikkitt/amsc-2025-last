  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div>
            ...
            <p className="text-gray-800 mb-1">Delhsa Sdn Bhd</p>
            ...
            <p className="text-gray-700">Email: <a href="mailto:garychai@delhsa.com" className="text-blue-600 hover:underline">garychai@delhsa.com</a></p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-1">8-3-10, Block B, Ativo Plaza, 52200 Kuala Lumpur</p>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-1">1-60, Jalan PUJ 3/7, Taman Perindustrian Puncak Jalil, Bandar Putra Permai, 43300 Seri Kembangan, Selangor</p>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-1">Tel: 603-2333 2603</p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-xl font-bold mb-4 text-white bg-blue-800 -mx-6 px-6 py-3">Event Details</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div className="font-medium text-gray-700">Exhibition Dates</div>
          <div className="text-gray-900">6-7 August 2025</div>
          
          <div className="font-medium text-gray-700">Venue</div>
          <div className="text-gray-900">
            <a href="#" className="text-blue-600 hover:underline">Kuala Lumpur Convention Centre</a>
          </div>
        </div>
      </div>
    </div>
